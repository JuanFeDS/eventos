...
**Formato**: Taller
**Estado**: Contenido del taller definido · faltan slides del taller
...
- `docs/` — investigación y contenido base
  ...
  - [`taller-contenido.md`](docs/taller-contenido.md) — cronograma y corte de capítulos del taller (aprobado)
